...
public class LibroController {
	...
	public boolean insertLibro(String titolo, Float prezzo, int pagine) throws SQLException{
	...
	public int updateLibro(int id, String titolo, Float prezzo, int pagine) throws SQLException{
